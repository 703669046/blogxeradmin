            ...
            <div class="page-content">
                ...
                <div class="page-content-table">
                    <el-table
                        ...
                        v-loading="loading"
                    >
                        <el-table-column prop="publisher_name" width="150" label="发布者"></el-table-column>
                        <el-table-column prop="title" label="标题"></el-table-column>
                        <el-table-column prop="type" label="状态">
                            <template slot-scope="scope">{{approvalObj[scope.row.type]}}</template>
                        </el-table-column>
    ...
    methods: {
        ...
        async getPageData() {
            ...
            if (res.success) {
                ...
                // this.$parent.search.total=res.data.total;
                // this.$parent.search.pageSize=res.data.per_page;
                // this.$parent.search.currentPage=res.date.current_page
            }
        },
        viewClick(data){
            data.type=2
