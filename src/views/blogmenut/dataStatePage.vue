                ...
                <div class="submit-table">
                    <table class="tablelist">
                        <tr>
                            <td class="key">名称</td>
                            <td>
                                <el-input v-model="submitData.auth_name" @input="handleRender" autocomplete="off"></el-input>
                            </td>
                            <td class="key">上级</td>
                            <td>
                                <el-cascader
                            ...
                            <td>
                                <el-input v-model="submitData.auth_c" @input="handleRender" autocomplete="off"></el-input>
                            </td>
                        </tr>
                        <tr>
                            <td class="key">操作方法名</td>
                            <td>
                                <el-input v-model="submitData.auth_a" @input="handleRender" autocomplete="off"></el-input>
                            </td>
                            <td class="key">跳转路径</td>
                            <td>
                                <el-input v-model="submitData.path" @input="handleRender" autocomplete="off"></el-input>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="key">排序</td>
                            <td>
                                <el-input-number @input="handleRender"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="pl15">
                                    <el-button type="primary" size="mini" @click="btnType=!btnType">确认</el-button>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="5">
                                ...
                                <el-input v-else @input="handleRender" v-model="submitData.icon" autocomplete="off"></el-input>
                            </td>
                        </tr>
                    </table>
                </div>
...
import {addMeunt,updatMeunList} from "./api/index";
...
export default {
    ...
    methods: {
        // 启动函数
        submitStatus() {
            this.submitData.auth_name= this.isData.auth_name,
            this.submitData.auth_c= this.isData.auth_c,
            this.submitData.auth_a= this.isData.auth_a,
            this.submitData.path= this.isData.path,
            this.submitData.radio= JSON.stringify(this.isData.is_nav),
            this.submitData.is_check= this.isData.is_check,
            this.submitData.sort= this.isData.sort,
            this.submitData.id= this.isData.id,
            this.submitData.is_d=this.isData.is_d
        },
        ...
        async handleAdd(){
            this.submitData.menut_type=0;
            let param = JSON.parse(JSON.stringify(this.submitData))
            const cd = this.submitData.id?updatMeunList:addMeunt;
            let res = await cd(this.submitData);
            if(res.success){
