            ...
            <div class="imageViewer" v-show="imageViewer">
                ...
                <div class="img_content">
                    <img 
                        ...
                        :src="imgData.multiple === true?imgData.imgList[imgItem]:imgData.imgUrl" alt="图片加载失败">
                </div>
                <!-- 操作按钮 -->
                <div class="viewer-toolbar">
                    <div class="img-name">{{ imgData.name }}</div>
                    <ul>
                ...
                <!-- 切换 -->
                <div class="switchImg" v-show="imgData.multiple">
...
export default {
    ...
    methods:{
        ...
        leftSwitch(){                    //左边切换
            if(this.imgItem === 0){
                return this.imgItem = this.imgData.imgList.length -1;
            }
            this.imgItem -= 1;
        },
        rightSwitch(){                  //右边切换
            if(this.imgItem === this.imgData.imgList.length -1){
